...
if (checkRes.rows.length === 0) {
  ...
  await db.insert(schema.articles).values([
    ...
    { id: 'article_id_4', authorId: 'admin_id_1', type: 'ARTIGO', title: 'O silêncio que modula a consciência', slug: 'o-silencio-que-modula', excerpt: 'A importância do silêncio e da presença na jornada da evolução.', content: '<p>...</p>', coverImageUrl: 'https://images.unsplash.com/photo-1506126613408-eca07ce68773?auto=format&fit=crop&q=80&w=1200&h=600', tags: ['Filosofia', 'Consciência'], status: 'PUBLISHED', publishedAt: new Date(Date.now() - 1000000) },
    { id: 'article_id_5', authorId: 'user_id_1', type: 'ARTIGO', title: 'Frequências que constroem realidades', slug: 'frequencias-que-constroem', excerpt: 'A ciência moderna confirma o que os antigos já sabiam sobre vibração.', content: '<p>...</p>', coverImageUrl: 'https://images.unsplash.com/photo-1532094349884-543bc11b234d?auto=format&fit=crop&q=80&w=800&h=600', tags: ['Ciência'], status: 'PUBLISHED', publishedAt: new Date(Date.now() - 5000000) },
    { id: 'article_id_6', authorId: 'admin_id_1', type: 'ARTIGO', title: 'A arte como expressão do invisível', slug: 'a-arte-como-expressao', excerpt: 'Expressões que inspiram e conectam com o que não se vê.', content: '<p>...</p>', coverImageUrl: 'https://images.unsplash.com/photo-1513364776144-60967b0f800f?auto=format&fit=crop&q=80&w=800&h=600', tags: ['Artes'], status: 'PUBLISHED', publishedAt: new Date(Date.now() - 8000000) },
    { id: 'article_id_7', authorId: 'user_id_1', type: 'ARTIGO', title: 'Consciência expandida: um novo olhar', slug: 'consciencia-expandida', excerpt: 'Como expandir a consciência e acessar novas possibilidades.', content: '<p>...</p>', coverImageUrl: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&q=80&w=800&h=600', tags: ['Consciência'], status: 'PUBLISHED', publishedAt: new Date(Date.now() - 10000000) },
    { id: 'article_id_8', authorId: 'admin_id_1', type: 'ARTIGO', title: 'Propósito: a bússola que guia a vida', slug: 'proposito-a-bussola', excerpt: 'Explorar e viver o propósito é alinhar suas ações ao que realmente importa.', content: '<p>...</p>', coverImageUrl: 'https://images.unsplash.com/photo-1501139083538-0139583c060f?auto=format&fit=crop&q=80&w=800&h=600', tags: ['Propósito'], status: 'PUBLISHED', publishedAt: new Date(Date.now() - 12000000) },
    { id: 'article_id_9', authorId: 'user_id_1', type: 'ARTIGO', title: 'Tradições que preservam a sabedoria', slug: 'tradicoes-que-preservam', excerpt: 'O valor das tradições orais e dos saberes ancestrais na construção do futuro.', content: '<p>...</p>', coverImageUrl: 'https://images.unsplash.com/photo-1519074069444-1ba4fff66d16?auto=format&fit=crop&q=80&w=800&h=600', tags: ['Cultura'], status: 'PUBLISHED', publishedAt: new Date(Date.now() - 15000000) },
    { id: 'article_id_10', authorId: 'admin_id_1', type: 'ARTIGO', title: 'A filosofia como caminho de libertação', slug: 'a-filosofia-como-caminho', excerpt: 'Reflexões que libertam a mente e ampliam horizontes.', content: '<p>...</p>', coverImageUrl: 'https://images.unsplash.com/photo-1506869640319-baa1f24d7759?auto=format&fit=crop&q=80&w=800&h=600', tags: ['Filosofia'], status: 'PUBLISHED', publishedAt: new Date(Date.now() - 18000000) },
  ]);
