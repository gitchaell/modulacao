...
if (checkRes.rows.length === 0) {
  ...
  await db.insert(schema.articles).values([
    ...
    { id: 'article_id_4', authorId: 'admin_id_1', type: 'ARTIGO', title: 'A Importância da Meditação no Dia a Dia', slug: 'a-importancia-da-meditacao', excerpt: 'Descubra como a meditação pode transformar a sua rotina e melhorar seu bem-estar mental.', content: '<p>A meditação tem se mostrado eficaz para a saúde mental e controle emocional...</p>', status: 'PUBLISHED', publishedAt: new Date(Date.now() - 1000000) },
    { id: 'article_id_5', authorId: 'admin_id_1', type: 'ARTIGO', title: 'A Tecnologia e o Futuro do Ser Humano', slug: 'a-tecnologia-e-o-futuro', excerpt: 'Reflexões sobre a simbiose entre os avanços tecnológicos e a essência humana.', content: '<p>A tecnologia evolui a passos largos, mas como isso afeta a nossa essência...</p>', status: 'PUBLISHED', publishedAt: new Date(Date.now() - 5000000) },
  ]);
